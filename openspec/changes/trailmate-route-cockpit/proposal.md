...
The production app needs a route-first cockpit for the "路线 / 路线辅助" tab. The first viewport should answer where the hiker is, what comes next, whether the route is still reasonable to continue, and which action is primary right now.

## What Changes

- Redesign the route-assistance tab into a map-first route cockpit.
...
- Preserve the existing boundaries: route assistance only, no turn-by-turn guarantee, no automatic reroute, and no emergency promise.
